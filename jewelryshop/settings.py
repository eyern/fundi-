...
ALLOWED_HOSTS = ['127.0.0.1','fundi-production.up.railway.app','https://fundi-production.up.railway.app']

CSRF_TRUSTED_ORIGINS = ['https://fundi-production.up.railway.app']
